function [ ] = data2img_mat_24( fNameIn, fNameOut )
...
nfft = 2^12;window = 128;noverlap = 120;shift = window - noverlap;
sx = myspecgramnew_24(sum(Data_range_MTI(19:21,:)),window,nfft,shift); % best bin 19-20 for asl
...
axis xy
%ylim([-12/(3e8/2/25e9) 12/(3e8/2/25e9)]);
...
saveas(fig,'01050010_1573836822.png')
%set(gca,'xtick',[],'ytick',[])

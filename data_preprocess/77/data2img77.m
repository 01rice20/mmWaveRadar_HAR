function [ ] = data2img_77( fNameIn, fNameOut)
...
%       sx = myspecgramnew(rngpro(rBin,:),window,nfft,shift);
   sx = myspecgramnew_77(sum(rngpro(rBin,:,1)),window,nfft,shift); % mti filter and IQ correction
...
%     colorbar;
    ...
    saveas(fig, '04050029_1574626078_Raw_0.png');
    set(gca,'xtick',[],'ytick',[])
